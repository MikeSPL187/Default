...
import com.metrolist.music.ui.screens.wrapped.components.DisplayDigits
...
/** Opens the recap: the period in large digits, then the app name and what is coming. */
@Composable
        ...
        AnimatedVisibility(
            ...
            Box(Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
                AutoResizingText(
                    ...
                    style = TextStyle(fontFamily = bbhBartle, textAlign = TextAlign.Center, letterSpacing = 2.sp, fontSize = 40.sp, color = colors.onSurface),
                )
            }
        }
